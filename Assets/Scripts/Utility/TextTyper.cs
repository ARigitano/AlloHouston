...
namespace CRI.HelloHouston.Utility
{
    public delegate void OnComplete(object sender);
    ...
    public static class TextTyperUtility
    {
        ...
        public static void TypeText(this Text label, string text, float speed = 0.05f, OnComplete onComplete = null)
        {
