...
public class Audio
{
        ...
        List<Audio> subAudios = null)
    {
        ...
        this._sourceTransform = _soundManager.gameObject.transform;
    ...
    void ApplyGlobalVolumeSettings()
    {
        switch (this._audioType)
        {
            case AudioType.Music:
                audioSource.volume = this._volume * _soundManager.globalMusicVolume * _soundManager.globalVolume;
                break;
            case AudioType.Sound:
                audioSource.volume = this._volume * _soundManager.globalSoundsVolume * _soundManager.globalVolume;
                break;
        }
    }
