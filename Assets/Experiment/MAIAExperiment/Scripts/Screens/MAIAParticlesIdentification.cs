...
{
    public class MAIAParticlesIdentification : MonoBehaviour
    {
        ...
        /// Particle grid cell dictionary.
        /// </summary>
        private Dictionary<Particle, MAIAParticleGridCell> _chargeGridCellDictionary;
        ...
        private void InitParticleGridCellDictionary()
        {
            ...
            foreach (var particleGroup in _maiaTopScreen.maiaManager.settings.allParticles.Where(particle => !particle.negative).OrderBy(particle => particle.symbol).GroupBy(particle => particle))
            {
                ...
                particleGridCell.Init(particleGroup.Key, MAIAParticleGridCellType.SignlessSymbol);
        ...
        {
            _chargeGridCellDictionary = new Dictionary<Particle, MAIAParticleGridCell>();
            ...
            foreach (var particleGroup in _maiaTopScreen.maiaManager.settings.allParticles.Where(particle => particle.line).OrderBy(particle => particle.symbol).ThenBy(particle => particle.negative).GroupBy(particle => particle))
            {
                ...
                particleGridCell.Init(particleGroup.Key, MAIAParticleGridCellType.TubeSymbol);
                particleGridCell.SetText("0");
