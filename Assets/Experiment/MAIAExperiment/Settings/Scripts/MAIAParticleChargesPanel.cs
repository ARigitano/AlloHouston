...

        {
            ...
            if (count == _manager.generatedParticles.Count(particle => particle.line))
            {
                ...
                else
                {
                    ...
                    ParticleSendErrorMessage(MAIAParticlesIdentification.ErrorType.WrongCharges);
                }
            }
            else
            {
                //A combination of particles with a wrong length has been entered.
                ParticleSendErrorMessage(MAIAParticlesIdentification.ErrorType.WrongNumberCharges);
            }
        }
