...
namespace Assets.ManusVR.Scripts
{
    ...
    public class Apollo : MonoBehaviour
    {
        ...
        private enum GloveState
        {
            ...
            GLOVE_1_GET_INFO,
            GLOVE_2_FILTER_CONVERT,
            GLOVE_3_ADD_TO_STREAM,
            GLOVE_4_SET_STREAM_DATA,
            GLOVE_5_SET_STREAM_RAW,
            GLOVE_6_SETUP,
        }
